 ...
 *  is defined by setting the value of constant SENTINEL.
 */
 ...
 *  list and should therefore not be the value one would want to
...
int main() {
	...
	cout << "User " << SENTINEL << " to signal the end." << endl;
	int total = 0;
	while(true) {
		int value;
		cout << " ? ";
